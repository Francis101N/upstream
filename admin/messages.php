            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                <div class="navbar-header" data-logobg="skin6">
                    ...
                    <a class="navbar-brand" href="dashboard">
                        ...
                        <b class="logo-icon">
                            <!-- Dark Logo icon -->
                           <img src="plugins/images/Upstream-logo-copy.png" width="160px" alt="homepage" />
                        </b>
                        <!--End Logo icon -->
                        <!-- Logo text -->
                        ...
                        <li>
                            <a class="profile-pic" href="#">
                                <img src="plugins/images/users/varun.jpg" alt="user-img" width="36"
                                    class="img-circle"><span class="text-white font-medium">Admin <?php echo $_SESSION['admin_user'];?></span></a>
                        </li>
                        <!-- ============================================================== -->
                        <!-- User profile and search -->
                        <!-- ============================================================== -->
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo substr(strip_tags($row['email']), 0, 100); ?>...
                                                </td>
                                                <td>
                                                    <?php echo substr(strip_tags($row['subject']), 0, 100); ?>...
                                                </td>
                                                <td>
                                                    <?php echo substr(strip_tags($row['message']), 0, 100); ?>...
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="deleteMessage?id=<?php echo $row['id']; ?>"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-upsteamRed">
                                                            <h3 class="modal-title"
                                                                id="exampleModalLabel<?php echo $row['id']; ?>"><b>FULLNAMES:</b> 
                                                                <?php echo htmlspecialchars($row['fullnames']); ?>
                                                            </h3>
                                                            <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <h4><b>EMAIL:</b>  <?php echo htmlspecialchars($row['email']); ?></h4>
                                                            <h5><b>SUBJECT:</b> <?php echo nl2br($row['subject']); ?></h5>
                                                            <p><b>MESSAGE:</b> <?php echo nl2br($row['message']); ?></p>

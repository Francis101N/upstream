...
function debitCard($checkIn, $checkOut, $roomType, $noNight, $amount, $email, $firstname, $lastname, $phone)
{
    ...
    $subject = "Confirmation of Room Reservation and Payment - upstream";

    $message = "
    Thank you for choosing upstream for your upcoming stay! We are delighted to confirm your room reservation and would like to express our appreciation for your prompt payment.<br><br>
    ...
    Upon your arrival, our dedicated staff will be ready to ensure you have a comfortable and enjoyable stay at upstream. If you have any further questions or concerns, feel free to reach out to us via email or phone.<br><br>

    We look forward to welcoming you to upstream and hope you have a pleasant and memorable stay with us.<br><br>
...
function bankTransfer($checkIn, $checkOut, $roomType, $noNight, $amount, $email, $firstname, $lastname, $phone)
{
    ...
    $message = "
    Thank you for choosing upstream for your upcoming stay! We are delighted to confirm your room reservation.<br><br>
    ...
    GTB 20383839839 upstream<br><br>
    ...
    We look forward to welcoming you to upstream and hope you have a pleasant and memorable stay with us.

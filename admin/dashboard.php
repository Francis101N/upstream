...
// Count Contacts
$contactsCount = 0;
$contactsQuery = mysqli_query($db, "SELECT COUNT(*) AS total FROM contacts");
if ($contactsRow = mysqli_fetch_assoc($contactsQuery)) {
    $contactsCount = $contactsRow['total'];
}
?>
                        ...
                        <a href="news" class="text-decoration-none">
                            <div class="white-box analytics-info d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" fill="#601000"
                                        viewBox="0 0 24 24">
                                        <path d="M4 4h16v2H4zm0 4h16v2H4zm0 4h10v2H4zm0 4h7v2H4z" />
                                    </svg>

                                    <div>
                                        <h3 class="box-title text-dark mb-0">News & Insights</h3>
                        ...
                        <a href="contacts" class="text-decoration-none">
                            <div class="white-box analytics-info d-flex align-items-center justify-content-between">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    ...
                                    <div>
                                        <h3 class="box-title text-dark mb-0">Contacts</h3>

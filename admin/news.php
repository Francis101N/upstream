            ...
            <div class="page-breadcrumb bg-white">
                <div class="row align-items-center">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title p-2">News / Insights ( <span class="text-danger"><?= $num; ?></span> )</h4>
                    </div>
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                        <div class="d-md-flex">
                            ...
                            <a href="add_news" class ="btn btn-danger text-white">ADD NEWS</a>
                                    ...
                                    <tbody>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php echo substr(strip_tags($row['blog_story']), 0, 100); ?>...
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="update_blog?id=<?php echo $row['id']; ?>"
                                                    ...
                                                    <div class="modal-content">
                                                        <div class="modal-header bg-upsteamRed">
                                                            <h3 class="modal-title"
                                                                id="exampleModalLabel<?php echo $row['id']; ?>"><b>BLOG
                                                                    TITLE: </b>
                                                        ...
                                                        <div class="modal-body"><b>BLOG IMAGE: </b>
                                                            <?php if (!empty($row['blog_img'])): ?>
                                                                <img src="uploads/<?php echo $row['blog_img']; ?>"
                                                                    class="img-fluid mb-3" alt="Blog Image"
                                                                    style="width:250px;height:200px;object-fit:cover;">
                                                            <?php endif; ?>

                                                            <p><b>BLOG STORY: </b><?php echo nl2br($row['blog_story']); ?>
                                                            </p>

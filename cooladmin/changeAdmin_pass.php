        ...
        <div class="page-container">
            ...
            <div class="main-content container">
                <div class="card">
                    ...
                    <?php
                    if ($section == 'pass-change') {
                        echo '<div class="alert alert-success m-2" role="alert">
                Your password has been changed successfully.
                 </div>';
                    }

                    if ($section == 'pass-error') {
                        echo '<div class="alert alert-danger m-2" role="alert">
                 Error - Password change failed, Be sure password and Confirm-password Matches.
                </div>';
                    }
                    ?>
                    <div class="card-body card-block">
                        <form action="proc_changeAdminPass" method="post" class="">
                            <div class="form-group">
                                <label for="password" class=" form-control-label">PASSWORD</label>
                                <input type="password" id="password" name="password" placeholder="password.."
                                    class="form-control">
                                <span class="help-block"><small>Enter password</small></span>
                            </div>
                            <div class="form-group">
                                ...
                                <span class="help-block"><small>Please re-enter your password</small></span>
                            </div>

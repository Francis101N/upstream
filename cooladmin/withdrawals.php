...
<body class="animsition">
    <div class="page-wrapper">
            ...
            <div class="main-content m-2">
                <div class="section__content section__content--p30">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <!-- DATA TABLE -->
                            <h3 class="title-5 mb-4 text-primary fw-bold">Withdrawals Overview</h3>
                                ...
                                <table class="table table-striped table-hover align-middle shadow-sm"
                                    ...
                                    <tbody class="text-center" style="font-size: 15px;">
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<td>" . htmlspecialchars($row['wallet_type']) . "</td>";
                                            ...
                                            $statusClass = ($status === 'Approved') ? 'success' : (($status === 'Pending') ? 'warning' : 'danger');
                                            echo "<td><span class='badge bg-$statusClass px-3 py-2'>$status</span></td>";
      ...
      <div class='d-flex justify-content-center gap-2'>
        <a href='edit_withdrawal?token=" . $row['token'] . "' 
        ...
        <a href='delete_withdrawal?token=" . $row['token'] . "' 

...
<head>
    ...
    <!-- Title Page-->
    <title>Account Holders - trustvaultglobal</title>
                            ...
                            <div class="table-responsive">
                                <div class="table-responsive">
                                    <table class="table table-striped table-hover table-bordered align-middle"
                                        ...
                                        <tbody>
                                            <?php
                                            $query = 'SELECT * FROM registration ORDER BY date_created DESC';
                                            ...
                                            while ($row = mysqli_fetch_assoc($result)) {
                                                ...
                                                echo "<td><img src='../account/" . htmlspecialchars($row['passport']) . "' width='60' height='60' /></td>";
                                                echo "<td>" . htmlspecialchars($row['bitcoin_address']) . "</td>";
                                                echo "<td>" . htmlspecialchars($row['usdt_address']) . "</td>";
                                                echo "<td>" . htmlspecialchars($row['eth_address']) . "</td>";
                                                echo "<td>$" . number_format($row['account_balance'], 2) . "</td>";
                                                echo "<td>" . htmlspecialchars($row['ref']) . "</td>";
                                                echo "<td>$" . number_format($row['total_referral_bonus'], 2) . "</td>";

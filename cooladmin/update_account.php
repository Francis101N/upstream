                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <div class="card">
                                    ...
                                    <div class="card-body">
                                        <?php
                                        // Generate a 6-digit reference number starting with 000
                                        $referenceNumber = '000' . str_pad(mt_rand(0, 999), 3, '0', STR_PAD_LEFT);
                                        ?>
                                        <form action="proc_updateAcc" method="post" novalidate="novalidate">
                                            <div class="form-group">
                                                <label for="accountid" class="control-label mb-1">Enter the Account
                                                    ID</label>
                                                <select id="accountid" name="accountid" class="form-control"
                                                    ...
                                                    if ($result && mysqli_num_rows($result) > 0) {
                                                        while ($row = mysqli_fetch_assoc($result)) {
                                                            $accid = htmlspecialchars($row['account_id']);
                                                            echo "<option value='$accid'>$accid</option>";
                                                        }
                                                    } else {
                                            ...
                                            <div class="form-group has-success">
                                                <label for="date/time" class="control-label mb-1">Date/Time</label>
                                                <input id="date/time" name="date/time" type="text"
                                                    class="form-control date/time" data-val="true"
                                                    placeholder="2025-09-25 11:00am" autocomplete="date/time"
                                                    aria-required="true" aria-invalid="false"
                                                    aria-describedby="date/time-error">
                                                <span class="help-block field-validation-valid"
                                                    data-valmsg-for="date/time" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="from" class="control-label mb-1">From</label>
                                                <input id="from" name="from" type="text" class="form-control from"
                                                    data-val="true" placeholder="Input sender name" autocomplete="from"
                                                    aria-required="true" aria-invalid="false"
                                                    aria-describedby="from-error">
                                                <span class="help-block field-validation-valid" data-valmsg-for="from"
                                                    data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group has-success">
                                                <label for="amount" class="control-label mb-1">Amount</label>
                                                <input id="amount" name="amount" type="number"
                                                    class="form-control amount" data-val="true"
                                                    placeholder="E.g 5000 no commas" autocomplete="amount"
                                                    aria-required="true" aria-invalid="false"
                                            ...
                                            <div class="form-group has-success">
                                                <label for="currency" class="control-label mb-1">Currency</label>
                                                <select id="currency" name="currency"
                                                    class="form-control currency valid" data-val="true"
                                                    aria-required="true" aria-invalid="false"
                                                ...
                                                <span class="help-block field-validation-valid"
                                                    data-valmsg-for="currency" data-valmsg-replace="true"></span>
                                            </div>
                                            <div class="form-group">
                                                <label for="reference" class="control-label mb-1">Reference</label>
                                                <input id="reference" name="reference" type="text"
                                                    class="form-control reference"
                                                    value="<?php echo $referenceNumber; ?>" readonly>
                                                <span class="help-block" data-valmsg-for="reference"
                                                    data-valmsg-replace="true"></span>
                                            </div>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-12 col-md-9">
                                                    <textarea name="transaction" id="textarea-input" rows="4"
                                                        class="form-control" required></textarea>
                                                </div>
                                            </div>
                                            <div class="form-group">
                                                <label for="transfermodule" class="control-label mb-1">Show Transfer
                                                    module</label>
                                                <select id="transfermodule" name="transfermodule" class="form-control"
                                                    aria-required="true" aria-invalid="false" required>
                                            ...
                                            <div>
                                                <button type="submit" class="btn btn-success btn-sm">
                                                    <i class="fa fa-dot-circle-o"></i> Update This Account
                                                </button>

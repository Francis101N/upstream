            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
                ...
                <div
                    ...
                    <div class="relative overflow-hidden">
                        <img src="https://dev.upstreaminnigeria.com/upload/team_images/1826371817882704.jpg"
                            alt="Sarritta Kassis"
                            class="w-full h-80 object-cover transition-transform duration-700 group-hover:scale-110">

                        <!-- Soft overlay -->
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition">
                        </div>
                    </div>

                    <div class="p-6 text-center space-y-2">
                        <h3 class="text-xl font-bold text-slate-900">Sarritta Kassis</h3>
                ...
                <!-- Card -->
                <div
                    class="reveal group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 delay-100">
                    <div class="relative overflow-hidden">
                        <img src="https://dev.upstreaminnigeria.com/upload/team_images/1825931965050381.jpg"
                            alt="Daniel Ubeh"
                            class="w-full h-80 object-cover transition-transform duration-700 group-hover:scale-110">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition">
                ...
                <!-- Card -->
                <div
                    class="reveal group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 delay-200">
                    <div class="relative overflow-hidden">
                        <img src="https://dev.upstreaminnigeria.com/upload/team_images/1825931913145220.jpg"
                            alt="Benjamin Akande"
                            class="w-full h-80 object-cover transition-transform duration-700 group-hover:scale-110">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition">
                ...
                <!-- Card -->
                <div
                    class="reveal group bg-white rounded-3xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 delay-300">
                    <div class="relative overflow-hidden">
                        <img src="https://dev.upstreaminnigeria.com/upload/team_images/1825931824707958.jpg"
                            alt="Segun Faniran"
                            class="w-full h-80 object-cover transition-transform duration-700 group-hover:scale-110">
                        <div
                            class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition">
                    ...
                    <div class="p-6 text-center space-y-2">
                        ...
                        <p class="text-sm text-upsteamRed font-semibold">Chief Operations Officer</p>
                        <span
                            class="inline-block mt-2 px-4 py-1 text-xs font-bold rounded-full bg-slate-100 text-slate-600">
                            COO
                        </span>
